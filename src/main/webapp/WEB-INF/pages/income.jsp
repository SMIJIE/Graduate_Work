...
<aside class="right-side">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 form-group has-success">
            <c:url value="/addIncome" var="updateUrl"/>
            ...
            <c:if test="${emptyFields ne null}">
                <div class="alert alert-danger" role="alert">Empty or Invalid fields!</div>
            </c:if>
        </div>
        <%--Form for income--%>
        ...
        <div class="col-lg-8 form-group has-success">
            ...
            <nav aria-label="Page navigation">
                <ul class="pager">
                    <li class="previous"><a href="/income?month=<c:out value="${months - 1}"/>"><span
                            aria-hidden="true">&larr;</span>
                        Previous Month</a></li>

                    <span style="font-size: x-large">${currentMonth}</span>

                    <li class="next"><a href="/income?month=<c:out value="${months + 1}"/>">Next Month <span
            ...
            <table class="table table-condensed">
                ...
                <c:forEach items="${incomes}" var="incomeOne">
                    <tr>
                        ...
                        <td>${incomeOne.category}</td>
                        <td>${incomeOne.comment}</td>
                    </tr>
                </c:forEach>
            </table>
        </div>
