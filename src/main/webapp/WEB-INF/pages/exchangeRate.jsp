    ...
    <section class="sidebar">
        ...
        <%--Button for admins--%>
            <c:if test="${user.role eq 'ADMIN'}">
                <li class="active">
                    <a href="/usersForAdmin"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp; Show users</a>
                </li>
            </c:if>
            <%--Button for admins--%>
        </ul>
...
<aside class="right-side">
    <section class="content-header">
        <h1>Exchange Rate, ${currentDate}:</h1>
    </section>
    ...
    <div class="row">
        ...
        <table class="table table-bordered">
                ...
                <c:forEach items="${exchangeRates}" var="exchangeRate">
                    <tr>
                        <td>${exchangeRate.codeCurrency}</td>
